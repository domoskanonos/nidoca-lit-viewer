...
export class Nidoca {
  initDefaultComponents() {
    this._registeredElementsMap.set(
      "nidoca-form-upload",
      html` <nidoca-form-upload theme="primary"></nidoca-form-upload>`
    );

    //nidoca-list
    this.registeredElementsMap.set(
      "nidoca-list",
      html` <nidoca-list theme="secondary" selectionMode>
    ...
    this._registeredElementsMap.set(
      ...
      html` <nidoca-form-register
        @nidoca-form-register-submit="${(event: CustomEvent) => alert(JSON.stringify(event.detail))}"
    ...
    this._registeredElementsMap.set(
      ...
      html` <nidoca-form-reset-password
        @nidoca-form-reset-password-submit="${(event: CustomEvent) => alert(JSON.stringify(event.detail))}"
        theme="${NidocaTheme.PRIMARY}"
      ></nidoca-form-reset-password>`
    );
    ...
    this._registeredElementsMap.set(
      ...
      html` <nidoca-form-newsletter
        @nidoca-form-newsletter-submit="${(event: CustomEvent) => alert(JSON.stringify(event.detail))}"
