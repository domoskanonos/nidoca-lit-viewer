...
export class WebcomponentGuiWrapper {
    constructor(parent, webcomponentWrapper) {
        this.parent = parent;
        this.webcomponentWrapper = webcomponentWrapper;
    }
    getAsHtml() {
        const htmlString = `<${this.webcomponentWrapper.getTagName()}
...
`;
    ...
    getAsJavascript() {
        const htmlString = `<${this.webcomponentWrapper.getTagName()} id="meinElement"></${this.webcomponentWrapper.getTagName()}>
<script>
