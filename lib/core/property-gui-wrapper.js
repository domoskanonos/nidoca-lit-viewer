...
export class PropertyGuiWrapper {
    ...
    getInputElement(classGuiWrapper) {
        ...
        const classWrapper = classGuiWrapper.webcomponentWrapper;
    ...
    getAsHtml(classGuiWrapper) {
        ...
        switch (propertyType) {
            ...
            case RenderType.Array:
                return "";
            default:
                return `${this.propertyWrapper.propertyName}="${classGuiWrapper.webcomponentWrapper.instance[this.propertyWrapper.propertyName]}"\n`;
        }
    }
    ...
    getAsJavascript(classGuiWrapper) {
        ...
        switch (propertyType) {
            ...
            case RenderType.Array:
                return "";
            case RenderType.String:
                return `element.${this.propertyWrapper.propertyName}="${classGuiWrapper.webcomponentWrapper.instance[this.propertyWrapper.propertyName]}";\n`;
            default:
                return `element.${this.propertyWrapper.propertyName}=${classGuiWrapper.webcomponentWrapper.instance[this.propertyWrapper.propertyName]};\n`;
        }
    }
